...
for DIM in $DIM_list;do
    ...
    CUDA_VISIBLE_DEVICES=7   python MCA_train.py -data $DATA  -net bn  -init orth -lr 1e-5 -dim $DIM -alpha 24 -n_cluster 5  -BatchSize 128 -loss $loss  -epochs 51 -checkpoints $checkpoints -log_dir $loss/$DATA/$DIM  -save_step 10
