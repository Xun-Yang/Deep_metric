#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=8 python train.py -data cub -net bn  -base 0.1  -init rand   -s 150  -lr 1e-6 -dim 512   -num_instances 8 -BatchSize 128  -loss distance_match  -epochs 601 -log_dir dist_match_neig_mine  -save_step 50
