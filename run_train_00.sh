#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=3 python train.py -data cub -net bn  -base 0.1  -init rand   -s 200  -lr 1e-6 -dim 512   -num_instances 8 -BatchSize 128  -loss softneig  -epochs 601 -log_dir all_pos_28_neg_2  -save_step 50
