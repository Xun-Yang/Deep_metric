#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=7 python train.py -data cub -net branch  -lr 1e-6 -dim 512   -num_instances 8 -BatchSize 128  -loss dwdevbranch  -epochs 401 -log_dir dwdevbranch  -save_step 50
