#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=6 python train.py -data cub -net bn  -lr 1e-6 -dim 512   -num_instances 8 -BatchSize 128  -loss dwdev  -epochs 301 -log_dir dwdev  -save_step 50
...
python test.py -r checkpoints/dwdev/150_model.pkl -test 0
python test.py -r checkpoints/dwdev/250_model.pkl
python test.py -r checkpoints/dwdev/300_model.pkl
python test.py -r checkpoints/dwdev/300_model.pkl -test 0
