...
def main(args):
    ...
    criterion = losses.create(args.loss, k=args.k, alpha=args.alpha, beta=args.beta).cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-alpha', default=20, type=int, metavar='n',
                        help='hyper parameter in KNN Softmax')
    parser.add_argument('-beta', default=20, type=int, metavar='n',
                        help='hyper parameter in KNN Softmax')
