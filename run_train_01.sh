#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=8 python train.py -data cub -net bn -base 0.1  -init rand   -s 270  -lr 1e-6 -dim 512   -num_instances 8 -BatchSize 128  -loss edwneig  -epochs 701 -log_dir edw_neighbour_unbalance  -save_step 50
