...
CUDA_VISIBLE_DEVICES=8 python train.py -data $DATA  -net bn  -init orth -lr 1e-5 -dim $DIM -alpha 40   -num_instances 8 -BatchSize 128 -loss $loss  -epochs 1001 -log_dir $loss/$DATA/$DIM  -save_step 100
