#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=5 python train.py -data cub -net bn -m 0.44 -lr 1e-6 -dim 512   -num_instances 8 -BatchSize 128  -loss dwdev  -epochs 401 -log_dir dwdev  -save_step 50
